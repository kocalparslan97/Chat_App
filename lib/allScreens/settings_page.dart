...
class _SettingsPageStateState extends State<SettingsPageState> {
  ...
  Future uploadFile() async {
    ...
    try {
      ...
      UserChat updateInfo = UserChat(id: id, photoUrl: photoUrl, nickname: nickname, aboutMe: aboutMe, phoneNumber: phoneNumber);
                  ...
                  child: avatarImageFile == null
                      ? photoUrl.isNotEmpty
                          ? ClipRRect(
                              ...
                              child: Image.network(photoUrl, fit: BoxFit.cover, width: 90, height: 90, errorBuilder: (context, object, stackTrace) {
                                return Icon(
