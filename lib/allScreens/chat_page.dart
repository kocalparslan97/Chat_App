...
class ChatPageState extends State<ChatPage> {
  ...
  Future<bool> onBackPress() {
    if (isShowSticker) {
      ...
      chatProvider.updateDataFirestore(FirestoreConstants.pathUserCollection, currentUserId, {FirestoreConstants.chattingWith: null});
          ...
          children: <Widget>[
            messageChat.type == TypeMessage.text
                ...
                : messageChat.type == TypeMessage.image
                    ...
                    : Container(
                        child: Image.asset('images/${messageChat.content}.gif', width: 100, height: 100, fit: BoxFit.cover),
                        margin: EdgeInsets.only(bottom: isLastMessageRight(index) ? 20 : 10, right: 10),
                      ),
          ],
          ...
          child: Column(
            children: <Widget>[
              ...
              isLastMessageLeft(index)
                  ? Container(
                      child: Text(
                        DateFormat('dd MM yyyy, hh:mm a').format(DateTime.fromMillisecondsSinceEpoch(int.parse(messageChat.timestamp))),
